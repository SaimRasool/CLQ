...
(function () {
    ...
    V.prototype.setOptions = function (h, m) { if (pa[this._defaultsKey]) { var s = pa[this._defaultsKey], v; for (v in s) "publicProperties" !== v && s.hasOwnProperty(v) && (this[v] = h && v in h ? h[v] : m && v in m ? m[v] : s[v]) } else Ga && window.console && console.log("defaults not set") }; V.prototype.get = function (h) {
        ...
        function () { return { x1: this._x1 + this._leftOccupied, y1: this._y1 + this._topOccupied, x2: this._x2 - this._rightOccupied, y2: this._y2 - this._bottomOccupied, width: this._x2 - this._x1 - this._rightOccupied - this._leftOccupied, height: this._y2 - this._y1 - this._bottomOccupied - this._topOccupied } }; Ca.prototype.reset = function () { this._rightOccupied = this._leftOccupied = this._bottomOccupied = this._topOccupied = this._padding }; na(ia, V); ia.prototype._initialize = function () {
            ...
            "undefined" !== typeof module.exports ? module.exports = Oa : "function" === typeof define && define.amd ? define([], function () { return Oa }) : (window.CanvasJS && window.console && window.console.log("CanvasJS namespace already exists. If you are loading both chart and stockchart scripts, just load stockchart alone as it includes all chart features."), window.CanvasJS = window.CanvasJS ? window.CanvasJS : Oa); y = Oa.Chart = function () {
                ...
                m.prototype.renderStackedArea = function (a) {
                    ...
                    function d() { for (var a = 0, b = [], c = 0; c < x.length; c++) { if ("undefined" === typeof x[c].y) return -1; x[c].y = "number" === typeof x[c].y ? x[c].y : 0; a += Math.abs(x[c].y) } if (0 === a) return -1; for (c = b[0] = 0; c < x.length; c++)b.push(Math.abs(x[c].y) * D / a); return b } function c() {
                        ...
                        var d, e, g, l = [], h = E, p = []; -1 !== b && (0 <= Y.indexOf(b) ? (e = Y.indexOf(b), Y.splice(e, 1)) : (Y.push(b), Y = Y.sort(function (a, b) { return a - b }))); if (0 === Y.length) l = ga; else {
                            e = E * (1 != Y.length || 0 != Y[0] && Y[0] != O.length -
                                1 ? 2 : 1) / k(); for (var q = 0; q < O.length; q++) { if (1 == Y.length && 0 == Y[0]) { if (0 === q) { l.push(ga[q]); d = h; continue } } else 0 === q && (d = -1 * h); l.push(ga[q] + d); if (0 <= Y.indexOf(q) || q < O.length && 0 <= Y.indexOf(q + 1)) d += e }
                            ...
                            typeof x[P].label && null !== x[P].label && 0 < x[P].label.toString().length) && (H = !0), !H && "function" === typeof t.indexLabelFormatter || "function" === typeof x[P].indexLabelFormatter) H = !0; H = H || "undefined" !== typeof t.indexLabel && null !== t.indexLabel && 0 < t.indexLabel.toString().length; "inside" !== t.indexLabelPlacement && H || (C = (z.width - 0.75 * F) / 2); var P = z.x1 + C, J = z.x2 - C, M = z.y1 + E, Q = z.y2 - E, R = a.targetCanvasCtx || this.plotArea.ctx || this.ctx; if (0 != t.length && (t.dataPoints && t.visible) && 0 !== x.length) {
                                var ba, G; a = 75 * F / 100; var V =
                                    30 * (J - a) / 100; "funnel" === t.type ? (ba = s(t.options.neckHeight) ? 0.35 * D : t.neckHeight, G = s(t.options.neckWidth) ? 0.25 * a : t.neckWidth, "string" === typeof ba && ba.match(/%$/) ? (ba = parseInt(ba), ba = ba * D / 100) : ba = parseInt(ba), "string" === typeof G && G.match(/%$/) ? (G = parseInt(G), G = G * a / 100) : G = parseInt(G), ba > D ? ba = D : 0 >= ba && (ba = 0), G > a ? G = a - 0.5 : 0 >= G && (G = 0)) : "pyramid" === t.type && (G = ba = 0, t.reversed = t.reversed ? !1 : !0); var C = P + a / 2, X = P, Z = P + a, ma = t.reversed ? Q : M, K = C - G / 2, W = C + G / 2, wa = t.reversed ? M + ba : Q - ba, ra = t.reversed ? M : Q; a = []; var C = [], O =
                                        [], F = [], U = M, ca, $ = (wa - ma) / (K - X), ea = -$, P = "area" === (t.valueRepresents ? t.valueRepresents : "height") ? c() : d(); if (-1 !== P) {
                                            if (t.reversed) for (F.push(U), G = P.length - 1; 0 < G; G--)U += P[G], F.push(U); else for (G = 0; G < P.length; G++)U += P[G], F.push(U); if (t.reversed) for (G = 0; G < P.length; G++)F[G] < wa ? (a.push(K), C.push(W), ca = G) : (a.push((F[G] - ma + $ * X) / $), C.push((F[G] - ma + ea * Z) / ea)); else for (G = 0; G < P.length; G++)F[G] < wa ? (a.push((F[G] - ma + $ * X) / $), C.push((F[G] - ma + ea * Z) / ea), ca = G) : (a.push(K), C.push(W)); for (G = 0; G < P.length - 1; G++)U = t.reversed ?
            ...
            }(); y.version = "v3.2.13 GA"; window.CanvasJS && (y && !window.CanvasJS.Chart) && (window.CanvasJS.Chart = y)
})();
